        ...
        thread::Builder::new()
            ...
            .spawn(move || {
                ...
                match worker_type {
                    ...
                    WorkerType::Module => {
                        // NOTE(pylbrecht): we can take options set up for classic script requests,
                        // as they are the same as the ones for module script requests
                        // https://html.spec.whatwg.org/multipage/webappapis.html#set-up-the-classic-script-request
                        // https://html.spec.whatwg.org/multipage/webappapis.html#set-up-the-module-script-request
                        let options = ScriptFetchOptions {
                            referrer: request.referrer,
                            integrity_metadata: request.integrity_metadata, // FIXME(pylbrecht)
